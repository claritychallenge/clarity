...
def haaqi_v1(x, fx, y, fy, HL, eq, Level1=65):
    """
    ...
    dloud, dnorm, dslope = eb.SpectDiff(xSL, ySL)
    ...
    sigcov, sigMSx, sigMSy = eb.BMcovary(xBM, yBM, segcov, fsamp)
    ...
    # Dnorm:std
    d = dnorm[1]  # Slope difference std
