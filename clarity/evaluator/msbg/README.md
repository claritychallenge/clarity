...
Three degrees of broadening are available, *1.5, *2 and *3 broadening (see "cochlear_simulate.m"), but now with greater overlap of filters (~33% hyper-sampled, 1.1-, 1.5- & 2.3-ERBn spaced).
