...
def predict(cfg: DictConfig):
    ...
    # Infer system, scene and listener from signal name
    for record in records:
        signal_parts = record["signal"].split("_")
        record["system"] = signal_parts[0] + "_" + signal_parts[1]
        record["scene"] = signal_parts[2]
        record["listener"] = signal_parts[3]
